...
| เวลา | งาน | Prompt ที่ถาม | AI ตอบว่าอะไร | ฉันทำอะไรต่อ |
|---|---|---|---|---|
| 11:15 | B1.1-B1.6 | ถามว่าทำไม state ไม่อัปเดต กับวิธีแก้ Warning เรื่อง key ใน list | บอกว่าลืมใส่ key, ใช้ตัวแปร state ผิด, และลืมใส่ dependency ใน useEffect | ไล่แก้โค้ดทีละไฟล์ตามจุดที่ AI บอกจน error/warning หายหมด |
