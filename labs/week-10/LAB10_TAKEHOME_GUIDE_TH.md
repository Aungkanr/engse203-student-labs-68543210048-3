...
- [x] ทุก query ที่รับค่าจากผู้ใช้ใช้ `?` ทั้งหมด
- [x] ยิงทดสอบครบ 3 แบบ ได้ 0 รายการทุกครั้ง
- [x] ตารางยังอยู่หลังยิงแบบ DROP
- [x] บันทึกผลพร้อมคำอธิบายว่าทำไมถึงกันได้
...
- [x] constraint error ตอบ 4xx ไม่ใช่ 500
- [x] ข้อความเป็นภาษาคน ไม่ใช่ข้อความจากฐานข้อมูล
- [x] error ที่เป็นความผิดของเซิร์ฟเวอร์จริง ๆ ยังตอบ 500
...
- [x] มี test อย่างน้อย 6 เคส
- [x] ใช้ `request(app)` ยิงจริง
- [x] **มีเคสทดสอบ SQL injection**
- [x] รัน `npm test` แล้วผ่านทั้งหมด
- [x] รันซ้ำ 2 ครั้งแล้วยังผ่าน (ไม่มีข้อมูลค้าง)
...
- [x] มีหัวข้อ Data Model พร้อมตารางทั้งสอง
- [x] อธิบายว่าทำไมโครงในฐานข้อมูลไม่เหมือนที่ API ส่งออก
- [x] **ระบุพฤติกรรมของ POST ที่สร้าง user ให้อัตโนมัติ**
- [x] อัปเดตเวอร์ชันและประวัติการเปลี่ยนแปลง
