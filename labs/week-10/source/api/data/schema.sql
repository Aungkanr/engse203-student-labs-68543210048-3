...
CREATE TABLE requests (
  ...
  request_type  TEXT NOT NULL CHECK(request_type IN ('แจ้งซ่อม', 'ขอใช้อุปกรณ์', 'บริการบัญชีผู้ใช้', 'อื่น ๆ')),
...
INSERT INTO requests (id, requester_id, request_type, location, details, priority, status) VALUES
  ...
  ('REQ-007', 3, 'ขอใช้อุปกรณ์',    'ห้องประชุม 1',       'ขอยืมโปรเจคเตอร์เพิ่ม',             'urgent', 'in-progress'),
  ('REQ-008', 1, 'บริการบัญชีผู้ใช้', 'อาคารวิศวกรรม',      'รีเซ็ตรหัสผ่านเข้าระบบ',            'normal', 'completed');
INSERT INTO requests (id, requester_id, request_type, location, details, priority, status) VALUES
  ('REQ-009', 4, 'ขอใช้อุปกรณ์', 'ห้องสมุด', 'ขอยืมหูฟังสำหรับเรียนออนไลน์', 'normal', 'completed'),
  ('REQ-010', 2, 'แจ้งซ่อม', 'อาคารเรียนรวม', 'หน้าต่างในห้องเรียนปิดไม่ได้', 'urgent', 'pending');
