...
- [x] `node check-week07.mjs` ได้อย่างน้อย **31/36**
- [x] `cd api && npm test` ผ่านทุกเคส
- [x] เปิดทั้งสองฝั่งแล้วใช้แอปได้ครบทุกหน้า รวม PUT เปลี่ยนสถานะ
- [x] ปิด API แล้วแอปแสดงข้อความบอกสาเหตุ ไม่ใช่หน้าขาว

### เอกสารและหลักฐาน

- [x] `API_CONTRACT.md` ครบ 5 endpoint · ตัวอย่างมาจากของจริง
- [x] `evidence/API_TEST.md` กรอกตามผลจริง
- [x] Screenshot 3 ภาพ
- [x] `AI_USAGE.md` กรอกแล้ว

### Git

- [x] `.gitignore` มี `node_modules/`, `.env`, `.env.local`
- [x] `git status` สะอาด
- [x] push ขึ้น branch `unit3/week-07`
- [x] tag `lab-07-submission-v1`
