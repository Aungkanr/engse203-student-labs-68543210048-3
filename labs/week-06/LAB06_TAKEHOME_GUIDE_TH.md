...
|---|---|---|---|---|---|---|
| 1 | GET | `/api/requests` | — | 200 | 200 OK | ✅ |
| 2 | GET | `/api/requests/REQ-001` | — | 200 | 200 OK | ✅ |
| 3 | GET | `/api/requests/REQ-999` | — | 404 | 404 Not Found | ✅ |
| 4 | POST | `/api/requests` | ข้อมูลครบถูกต้อง | 201 | 201 Created | ✅ |
| 5 | POST | `/api/requests` | `{"requesterName":"x"}` | 400 | 400 Bad Request | ✅ |
| 6 | DELETE | `/api/requests/REQ-003` | — | 204 | 204 No Content | ✅ |
| 7 | DELETE | `/api/requests/REQ-999` | — | 404 | 404 Not Found |  ✅ |
| 8 | GET | `/api/unknown` | — | 404 |404 Not Found | ✅ |
